class dt {
  ...
  formatMessage(t, e, o, _) {
    const r = Date.now(), p = this.loggers.get(t);
    let u = t, n = "";
    p.lastTime && (n = `+${r - p.lastTime}ms`), p.lastTime = r, this.isNode ? (u = `\x1B[${this.getAnsiColor(p.color)}m${t}\x1B[0m`, n && (u += ` \x1B[90m${n}\x1B[0m`)) : n && (u += ` ${n}`);
    const l = e !== "debug" ? `[${e.toUpperCase()}]` : "";
    return `${u}${l ? " " + l : ""} ${o}`;
  }
  getAnsiColor(t) {
    return {
  ...
  log(t, e, o, ..._) {
    ...
    const p = this.formatMessage(t, e, o, _);
    if (this.isNode) {
      const u = e === "debug" ? process.stderr : process.stdout;
      u.write(p + " "), _.length > 0 && u.write(_.map(
        (n) => typeof n == "object" ? JSON.stringify(n, null, 2) : String(n)
      ).join(" ")), u.write(`
`);
    } else {
      const u = `color: ${r.color}; font-weight: bold;`;
      e === "warn" ? console.warn(`%c${p}`, u, ..._) : e === "error" ? console.error(`%c${p}`, u, ..._) : console.log(`%c${p}`, u, ..._);
    }
  }
  createLogger(t) {
    ...
    const e = this.loggers.get(t), o = (_, ...r) => {
      this.log(t, "debug", _, ...r);
    };
    return o.debug = (_, ...r) => {
      this.log(t, "debug", _, ...r);
    }, o.warn = (_, ...r) => {
...
const kt = { max_tokens: "LEGACY parameter. set to max_output_tokens if provider specifies it. IF not set to max_input_tokens, if provider specifies it.", max_input_tokens: "max input tokens, if the provider specifies it. if not default to max_tokens", max_output_tokens: "max output tokens, if the provider specifies it. if not default to max_tokens", input_cost_per_token: 0, output_cost_per_token: 0, output_cost_per_reasoning_token: 0, litellm_provider: "one of https://docs.litellm.ai/docs/providers", mode: "one of: chat, embedding, completion, image_generation, audio_transcription, audio_speech, image_generation, moderation, rerank", supports_function_calling: !0, supports_parallel_function_calling: !0, supports_vision: !0, supports_audio_input: !0, supports_audio_output: !0, supports_prompt_caching: !0, supports_response_schema: !0, supports_system_messages: !0, supports_reasoning: !0, supports_web_search: !0, search_context_cost_per_query: { search_context_size_low: 0, search_context_size_medium: 0, search_context_size_high: 0 }, supported_regions: ["global", "us-west-2", "eu-west-1", "ap-southeast-1", "ap-northeast-1"], deprecation_date: "date when the model becomes deprecated in the format YYYY-MM-DD" }, ht = { max_tokens: 1e5, max_input_tokens: 2e5, max_output_tokens: 1e5, input_cost_per_token: 15e-6, output_cost_per_token: 6e-5, cache_read_input_token_cost: 75e-7, litellm_provider: "openai", mode: "chat", supports_function_calling: !0, supports_parallel_function_calling: !0, supports_vision: !0, supports_pdf_input: !0, supports_prompt_caching: !0, supports_system_messages: !0, supports_response_schema: !0, supports_reasoning: !0, supports_tool_choice: !0 }, xt = { max_tokens: 1e5, max_input_tokens: 2e5, max_output_tokens: 1e5, input_cost_per_token: 2e-6, output_cost_per_token: 8e-6, cache_read_input_token_cost: 5e-7, litellm_provider: "openai", mode: "chat", supports_function_calling: !0, supports_parallel_function_calling: !1, supports_vision: !0, supports_pdf_input: !0, supports_prompt_caching: !0, supports_response_schema: !0, supports_reasoning: !0, supports_tool_choice: !0, supported_endpoints: ["/v1/responses", "/v1/chat/completions", "/v1/completions", "/v1/batch"], supported_modalities: ["text", "image"], supported_output_modalities: ["text"] }, gt = { max_tokens: 2048, max_input_tokens: 2048, output_vector_size: 768, input_cost_per_character: 2e-7, input_cost_per_image: 1e-4, input_cost_per_video_per_second: 5e-4, input_cost_per_video_per_second_above_8s_interval: 1e-3, input_cost_per_video_per_second_above_15s_interval: 2e-3, input_cost_per_token: 8e-7, output_cost_per_token: 0, litellm_provider: "vertex_ai-embedding-models", mode: "embedding", supported_endpoints: ["/v1/embeddings"], supported_modalities: ["text", "image", "video"], source: "https://cloud.google.com/vertex-ai/generative-ai/docs/learn/models" }, vt = { max_tokens: 4096, max_input_tokens: 4096, max_output_tokens: 4096, input_cost_per_token: 1e-6, output_cost_per_token: 2e-6, litellm_provider: "cohere", mode: "completion" }, ft = { max_tokens: 16384, max_input_tokens: 16384, max_output_tokens: 16384, input_cost_per_token: 5e-7, output_cost_per_token: 5e-7, litellm_provider: "nlp_cloud", mode: "completion" }, bt = { max_tokens: 16384, max_input_tokens: 16384, max_output_tokens: 16384, input_cost_per_token: 5e-7, output_cost_per_token: 5e-7, litellm_provider: "nlp_cloud", mode: "chat" }, rt = {
  ...
  "mistral/magistral-medium-latest": { max_tokens: 4e4, max_input_tokens: 4e4, max_output_tokens: 4e4, input_cost_per_token: 2e-6, output_cost_per_token: 5e-6, litellm_provider: "mistral", mode: "chat", source: "https://mistral.ai/news/magistral", supports_function_calling: !0, supports_assistant_prefill: !0, supports_tool_choice: !0, supports_reasoning: !0 },
  ...
  "mistral/magistral-small-latest": { max_tokens: 4e4, max_input_tokens: 4e4, max_output_tokens: 4e4, input_cost_per_token: 5e-7, output_cost_per_token: 15e-7, litellm_provider: "mistral", mode: "chat", source: "https://mistral.ai/pricing#api-pricing", supports_function_calling: !0, supports_assistant_prefill: !0, supports_tool_choice: !0, supports_reasoning: !0 },
  ...
  "xai/grok-3-latest": { max_tokens: 131072, max_input_tokens: 131072, max_output_tokens: 131072, input_cost_per_token: 3e-6, output_cost_per_token: 15e-6, litellm_provider: "xai", mode: "chat", supports_function_calling: !0, supports_tool_choice: !0, supports_response_schema: !1, source: "https://x.ai/api#pricing", supports_web_search: !0 },
  ...
  "meta_llama/Llama-4-Scout-17B-16E-Instruct-FP8": { max_tokens: 128e3, max_input_tokens: 1e7, max_output_tokens: 4028, litellm_provider: "meta_llama", mode: "chat", supports_function_calling: !0, source: "https://llama.developer.meta.com/docs/models", supports_tool_choice: !0, supported_modalities: ["text", "image"], supported_output_modalities: ["text"] },
  "meta_llama/Llama-4-Maverick-17B-128E-Instruct-FP8": { max_tokens: 128e3, max_input_tokens: 1e6, max_output_tokens: 4028, litellm_provider: "meta_llama", mode: "chat", supports_function_calling: !0, source: "https://llama.developer.meta.com/docs/models", supports_tool_choice: !0, supported_modalities: ["text", "image"], supported_output_modalities: ["text"] },
  "meta_llama/Llama-3.3-70B-Instruct": { max_tokens: 128e3, max_input_tokens: 128e3, max_output_tokens: 4028, litellm_provider: "meta_llama", mode: "chat", supports_function_calling: !0, source: "https://llama.developer.meta.com/docs/models", supports_tool_choice: !0, supported_modalities: ["text"], supported_output_modalities: ["text"] },
  "meta_llama/Llama-3.3-8B-Instruct": { max_tokens: 128e3, max_input_tokens: 128e3, max_output_tokens: 4028, litellm_provider: "meta_llama", mode: "chat", supports_function_calling: !0, source: "https://llama.developer.meta.com/docs/models", supports_tool_choice: !0, supported_modalities: ["text"], supported_output_modalities: ["text"] },
  ...
  "gemini-2.5-pro": { max_tokens: 65535, max_input_tokens: 1048576, max_output_tokens: 65535, max_images_per_prompt: 3e3, max_videos_per_prompt: 10, max_video_length: 1, max_audio_length_hours: 8.4, max_audio_per_prompt: 1, max_pdf_size_mb: 30, input_cost_per_token: 125e-8, input_cost_per_token_above_200k_tokens: 25e-7, output_cost_per_token: 1e-5, output_cost_per_token_above_200k_tokens: 15e-6, litellm_provider: "vertex_ai-language-models", mode: "chat", supports_system_messages: !0, supports_function_calling: !0, supports_vision: !0, supports_audio_input: !0, supports_video_input: !0, supports_pdf_input: !0, supports_response_schema: !0, supports_tool_choice: !0, supports_reasoning: !0, supported_endpoints: ["/v1/chat/completions", "/v1/completions"], supported_modalities: ["text", "image", "audio", "video"], supported_output_modalities: ["text"], source: "https://cloud.google.com/vertex-ai/generative-ai/pricing", supports_web_search: !0 },
  ...
  "gemini/gemini-2.5-pro": { max_tokens: 65535, max_input_tokens: 1048576, max_output_tokens: 65535, max_images_per_prompt: 3e3, max_videos_per_prompt: 10, max_video_length: 1, max_audio_length_hours: 8.4, max_audio_per_prompt: 1, max_pdf_size_mb: 30, input_cost_per_token: 125e-8, input_cost_per_token_above_200k_tokens: 25e-7, output_cost_per_token: 1e-5, output_cost_per_token_above_200k_tokens: 15e-6, litellm_provider: "gemini", mode: "chat", rpm: 2e3, tpm: 8e5, supports_system_messages: !0, supports_function_calling: !0, supports_vision: !0, supports_audio_input: !0, supports_video_input: !0, supports_pdf_input: !0, supports_response_schema: !0, supports_tool_choice: !0, supports_reasoning: !0, supported_endpoints: ["/v1/chat/completions", "/v1/completions"], supported_modalities: ["text", "image", "audio", "video"], supported_output_modalities: ["text"], source: "https://cloud.google.com/vertex-ai/generative-ai/pricing", supports_web_search: !0 },
  ...
  "gemini-2.5-flash": { max_tokens: 65535, max_input_tokens: 1048576, max_output_tokens: 65535, max_images_per_prompt: 3e3, max_videos_per_prompt: 10, max_video_length: 1, max_audio_length_hours: 8.4, max_audio_per_prompt: 1, max_pdf_size_mb: 30, input_cost_per_audio_token: 1e-6, input_cost_per_token: 3e-7, output_cost_per_token: 25e-7, output_cost_per_reasoning_token: 25e-7, litellm_provider: "vertex_ai-language-models", mode: "chat", supports_reasoning: !0, supports_system_messages: !0, supports_function_calling: !0, supports_vision: !0, supports_response_schema: !0, supports_audio_output: !1, supports_tool_choice: !0, supported_endpoints: ["/v1/chat/completions", "/v1/completions", "/v1/batch"], supported_modalities: ["text", "image", "audio", "video"], supported_output_modalities: ["text"], source: "https://ai.google.dev/gemini-api/docs/models#gemini-2.5-flash-preview", supports_parallel_function_calling: !0, supports_web_search: !0, supports_url_context: !0, supports_pdf_input: !0 },
  ...
  "gemini/gemini-2.5-flash-preview-05-20": { max_tokens: 65535, max_input_tokens: 1048576, max_output_tokens: 65535, max_images_per_prompt: 3e3, max_videos_per_prompt: 10, max_video_length: 1, max_audio_length_hours: 8.4, max_audio_per_prompt: 1, max_pdf_size_mb: 30, input_cost_per_audio_token: 1e-6, input_cost_per_token: 3e-7, output_cost_per_token: 25e-7, output_cost_per_reasoning_token: 25e-7, litellm_provider: "gemini", mode: "chat", rpm: 10, tpm: 25e4, supports_system_messages: !0, supports_function_calling: !0, supports_vision: !0, supports_reasoning: !0, supports_response_schema: !0, supports_audio_output: !1, supports_tool_choice: !0, supported_endpoints: ["/v1/chat/completions", "/v1/completions"], supported_modalities: ["text", "image", "audio", "video"], supported_output_modalities: ["text"], source: "https://ai.google.dev/gemini-api/docs/models#gemini-2.5-flash-preview", supports_web_search: !0, supports_url_context: !0, supports_pdf_input: !0 },
  "gemini/gemini-2.5-flash-preview-04-17": { max_tokens: 65535, max_input_tokens: 1048576, max_output_tokens: 65535, max_images_per_prompt: 3e3, max_videos_per_prompt: 10, max_video_length: 1, max_audio_length_hours: 8.4, max_audio_per_prompt: 1, max_pdf_size_mb: 30, input_cost_per_audio_token: 1e-6, input_cost_per_token: 15e-8, output_cost_per_token: 6e-7, output_cost_per_reasoning_token: 35e-7, litellm_provider: "gemini", mode: "chat", rpm: 10, tpm: 25e4, supports_system_messages: !0, supports_function_calling: !0, supports_vision: !0, supports_reasoning: !0, supports_response_schema: !0, supports_audio_output: !1, supports_tool_choice: !0, supported_endpoints: ["/v1/chat/completions", "/v1/completions"], supported_modalities: ["text", "image", "audio", "video"], supported_output_modalities: ["text"], source: "https://ai.google.dev/gemini-api/docs/models#gemini-2.5-flash-preview", supports_web_search: !0, supports_pdf_input: !0 },
  "gemini/gemini-2.5-flash-lite-preview-06-17": { max_tokens: 65535, max_input_tokens: 1048576, max_output_tokens: 65535, max_images_per_prompt: 3e3, max_videos_per_prompt: 10, max_video_length: 1, max_audio_length_hours: 8.4, max_audio_per_prompt: 1, max_pdf_size_mb: 30, input_cost_per_audio_token: 5e-7, input_cost_per_token: 1e-7, output_cost_per_token: 4e-7, output_cost_per_reasoning_token: 4e-7, litellm_provider: "gemini", mode: "chat", rpm: 15, tpm: 25e4, supports_reasoning: !0, supports_system_messages: !0, supports_function_calling: !0, supports_vision: !0, supports_response_schema: !0, supports_audio_output: !1, supports_tool_choice: !0, supported_endpoints: ["/v1/chat/completions", "/v1/completions", "/v1/batch"], supported_modalities: ["text", "image", "audio", "video"], supported_output_modalities: ["text"], source: "https://ai.google.dev/gemini-api/docs/models#gemini-2.5-flash-lite", supports_parallel_function_calling: !0, supports_web_search: !0, supports_url_context: !0, supports_pdf_input: !0 },
  "gemini-2.5-flash-preview-05-20": { max_tokens: 65535, max_input_tokens: 1048576, max_output_tokens: 65535, max_images_per_prompt: 3e3, max_videos_per_prompt: 10, max_video_length: 1, max_audio_length_hours: 8.4, max_audio_per_prompt: 1, max_pdf_size_mb: 30, input_cost_per_audio_token: 1e-6, input_cost_per_token: 3e-7, output_cost_per_token: 25e-7, output_cost_per_reasoning_token: 25e-7, litellm_provider: "vertex_ai-language-models", mode: "chat", supports_reasoning: !0, supports_system_messages: !0, supports_function_calling: !0, supports_vision: !0, supports_response_schema: !0, supports_audio_output: !1, supports_tool_choice: !0, supported_endpoints: ["/v1/chat/completions", "/v1/completions", "/v1/batch"], supported_modalities: ["text", "image", "audio", "video"], supported_output_modalities: ["text"], source: "https://ai.google.dev/gemini-api/docs/models#gemini-2.5-flash-preview", supports_parallel_function_calling: !0, supports_web_search: !0, supports_url_context: !0, supports_pdf_input: !0 },
  "gemini-2.5-flash-preview-04-17": { max_tokens: 65535, max_input_tokens: 1048576, max_output_tokens: 65535, max_images_per_prompt: 3e3, max_videos_per_prompt: 10, max_video_length: 1, max_audio_length_hours: 8.4, max_audio_per_prompt: 1, max_pdf_size_mb: 30, input_cost_per_audio_token: 1e-6, input_cost_per_token: 15e-8, output_cost_per_token: 6e-7, output_cost_per_reasoning_token: 35e-7, litellm_provider: "vertex_ai-language-models", mode: "chat", supports_reasoning: !0, supports_system_messages: !0, supports_function_calling: !0, supports_vision: !0, supports_response_schema: !0, supports_audio_output: !1, supports_tool_choice: !0, supported_endpoints: ["/v1/chat/completions", "/v1/completions", "/v1/batch"], supported_modalities: ["text", "image", "audio", "video"], supported_output_modalities: ["text"], source: "https://ai.google.dev/gemini-api/docs/models#gemini-2.5-flash-preview", supports_parallel_function_calling: !0, supports_web_search: !0, supports_pdf_input: !0 },
  ...
  "gemini-2.5-pro-preview-06-05": { max_tokens: 65535, max_input_tokens: 1048576, max_output_tokens: 65535, max_images_per_prompt: 3e3, max_videos_per_prompt: 10, max_video_length: 1, max_audio_length_hours: 8.4, max_audio_per_prompt: 1, max_pdf_size_mb: 30, input_cost_per_audio_token: 125e-8, input_cost_per_token: 125e-8, input_cost_per_token_above_200k_tokens: 25e-7, output_cost_per_token: 1e-5, output_cost_per_token_above_200k_tokens: 15e-6, litellm_provider: "vertex_ai-language-models", mode: "chat", supports_reasoning: !0, supports_system_messages: !0, supports_function_calling: !0, supports_vision: !0, supports_response_schema: !0, supports_audio_output: !1, supports_tool_choice: !0, supported_endpoints: ["/v1/chat/completions", "/v1/completions", "/v1/batch"], supported_modalities: ["text", "image", "audio", "video"], supported_output_modalities: ["text"], source: "https://ai.google.dev/gemini-api/docs/models#gemini-2.5-flash-preview", supports_parallel_function_calling: !0, supports_web_search: !0, supports_pdf_input: !0 },
  "gemini-2.5-pro-preview-05-06": { max_tokens: 65535, max_input_tokens: 1048576, max_output_tokens: 65535, max_images_per_prompt: 3e3, max_videos_per_prompt: 10, max_video_length: 1, max_audio_length_hours: 8.4, max_audio_per_prompt: 1, max_pdf_size_mb: 30, input_cost_per_audio_token: 125e-8, input_cost_per_token: 125e-8, input_cost_per_token_above_200k_tokens: 25e-7, output_cost_per_token: 1e-5, output_cost_per_token_above_200k_tokens: 15e-6, litellm_provider: "vertex_ai-language-models", mode: "chat", supports_reasoning: !0, supports_system_messages: !0, supports_function_calling: !0, supports_vision: !0, supports_response_schema: !0, supports_audio_output: !1, supports_tool_choice: !0, supported_endpoints: ["/v1/chat/completions", "/v1/completions", "/v1/batch"], supported_modalities: ["text", "image", "audio", "video"], supported_output_modalities: ["text"], supported_regions: ["global"], source: "https://ai.google.dev/gemini-api/docs/models#gemini-2.5-flash-preview", supports_parallel_function_calling: !0, supports_web_search: !0, supports_pdf_input: !0 },
  ...
  "gemini/gemini-2.5-pro-preview-06-05": { max_tokens: 65535, max_input_tokens: 1048576, max_output_tokens: 65535, max_images_per_prompt: 3e3, max_videos_per_prompt: 10, max_video_length: 1, max_audio_length_hours: 8.4, max_audio_per_prompt: 1, max_pdf_size_mb: 30, input_cost_per_audio_token: 7e-7, input_cost_per_token: 125e-8, input_cost_per_token_above_200k_tokens: 25e-7, output_cost_per_token: 1e-5, output_cost_per_token_above_200k_tokens: 15e-6, litellm_provider: "gemini", mode: "chat", rpm: 1e4, tpm: 1e7, supports_system_messages: !0, supports_function_calling: !0, supports_vision: !0, supports_response_schema: !0, supports_audio_output: !1, supports_tool_choice: !0, supported_modalities: ["text", "image", "audio", "video"], supported_output_modalities: ["text"], source: "https://ai.google.dev/gemini-api/docs/pricing#gemini-2.5-pro-preview", supports_web_search: !0, supports_url_context: !0, supports_pdf_input: !0 },
  "gemini/gemini-2.5-pro-preview-05-06": { max_tokens: 65535, max_input_tokens: 1048576, max_output_tokens: 65535, max_images_per_prompt: 3e3, max_videos_per_prompt: 10, max_video_length: 1, max_audio_length_hours: 8.4, max_audio_per_prompt: 1, max_pdf_size_mb: 30, input_cost_per_audio_token: 7e-7, input_cost_per_token: 125e-8, input_cost_per_token_above_200k_tokens: 25e-7, output_cost_per_token: 1e-5, output_cost_per_token_above_200k_tokens: 15e-6, litellm_provider: "gemini", mode: "chat", rpm: 1e4, tpm: 1e7, supports_system_messages: !0, supports_function_calling: !0, supports_vision: !0, supports_response_schema: !0, supports_audio_output: !1, supports_tool_choice: !0, supported_modalities: ["text", "image", "audio", "video"], supported_output_modalities: ["text"], source: "https://ai.google.dev/gemini-api/docs/pricing#gemini-2.5-pro-preview", supports_web_search: !0, supports_url_context: !0, supports_pdf_input: !0 },
  "gemini/gemini-2.5-pro-preview-03-25": { max_tokens: 65535, max_input_tokens: 1048576, max_output_tokens: 65535, max_images_per_prompt: 3e3, max_videos_per_prompt: 10, max_video_length: 1, max_audio_length_hours: 8.4, max_audio_per_prompt: 1, max_pdf_size_mb: 30, input_cost_per_audio_token: 7e-7, input_cost_per_token: 125e-8, input_cost_per_token_above_200k_tokens: 25e-7, output_cost_per_token: 1e-5, output_cost_per_token_above_200k_tokens: 15e-6, litellm_provider: "gemini", mode: "chat", rpm: 1e4, tpm: 1e7, supports_system_messages: !0, supports_function_calling: !0, supports_vision: !0, supports_response_schema: !0, supports_audio_output: !1, supports_tool_choice: !0, supported_modalities: ["text", "image", "audio", "video"], supported_output_modalities: ["text"], source: "https://ai.google.dev/gemini-api/docs/pricing#gemini-2.5-pro-preview", supports_web_search: !0, supports_pdf_input: !0 },
  ...
  "openrouter/anthropic/claude-sonnet-4": { supports_computer_use: !0, max_tokens: 8192, max_input_tokens: 2e5, max_output_tokens: 8192, input_cost_per_token: 3e-6, output_cost_per_token: 15e-6, input_cost_per_image: 48e-4, litellm_provider: "openrouter", mode: "chat", supports_function_calling: !0, supports_vision: !0, supports_reasoning: !0, tool_use_system_prompt_tokens: 159, supports_assistant_prefill: !0, supports_tool_choice: !0 },
  ...
  "openrouter/mistralai/mistral-small-3.1-24b-instruct": { max_tokens: 32e3, input_cost_per_token: 1e-7, output_cost_per_token: 3e-7, litellm_provider: "openrouter", mode: "chat", supports_tool_choice: !0 },
  "openrouter/mistralai/mistral-small-3.2-24b-instruct": { max_tokens: 32e3, input_cost_per_token: 1e-7, output_cost_per_token: 3e-7, litellm_provider: "openrouter", mode: "chat", supports_tool_choice: !0 },
  ...
  "apac.amazon.nova-micro-v1:0": { max_tokens: 1e4, max_input_tokens: 3e5, max_output_tokens: 1e4, input_cost_per_token: 37e-9, output_cost_per_token: 148e-9, litellm_provider: "bedrock_converse", mode: "chat", supports_function_calling: !0, supports_prompt_caching: !0, supports_response_schema: !0 },
  "apac.amazon.nova-lite-v1:0": { max_tokens: 1e4, max_input_tokens: 128e3, max_output_tokens: 1e4, input_cost_per_token: 63e-9, output_cost_per_token: 252e-9, litellm_provider: "bedrock_converse", mode: "chat", supports_function_calling: !0, supports_vision: !0, supports_pdf_input: !0, supports_prompt_caching: !0, supports_response_schema: !0 },
  "apac.amazon.nova-pro-v1:0": { max_tokens: 1e4, max_input_tokens: 3e5, max_output_tokens: 1e4, input_cost_per_token: 84e-8, output_cost_per_token: 336e-8, litellm_provider: "bedrock_converse", mode: "chat", supports_function_calling: !0, supports_vision: !0, supports_pdf_input: !0, supports_prompt_caching: !0, supports_response_schema: !0 },
  ...
  "apac.anthropic.claude-3-haiku-20240307-v1:0": { max_tokens: 4096, max_input_tokens: 2e5, max_output_tokens: 4096, input_cost_per_token: 25e-8, output_cost_per_token: 125e-8, litellm_provider: "bedrock", mode: "chat", supports_function_calling: !0, supports_response_schema: !0, supports_vision: !0, supports_pdf_input: !0, supports_tool_choice: !0 },
  ...
  "apac.anthropic.claude-3-5-sonnet-20241022-v2:0": { max_tokens: 8192, max_input_tokens: 2e5, max_output_tokens: 8192, input_cost_per_token: 3e-6, output_cost_per_token: 15e-6, cache_creation_input_token_cost: 375e-8, cache_read_input_token_cost: 3e-7, litellm_provider: "bedrock", mode: "chat", supports_function_calling: !0, supports_vision: !0, supports_assistant_prefill: !0, supports_computer_use: !0, supports_pdf_input: !0, supports_prompt_caching: !0, supports_response_schema: !0, supports_tool_choice: !0 },
  ...
  "perplexity/sonar-deep-research": { max_tokens: 128e3, max_input_tokens: 128e3, input_cost_per_token: 2e-6, output_cost_per_token: 8e-6, output_cost_per_reasoning_token: 3e-6, citation_cost_per_token: 2e-6, search_context_cost_per_query: { search_context_size_low: 5e-3, search_context_size_medium: 5e-3, search_context_size_high: 5e-3 }, litellm_provider: "perplexity", mode: "chat", supports_reasoning: !0, supports_web_search: !0 },
...
const y = class y {
  ...
  getModel(t, e = {}) {
    return y.get(this.service, t, e);
  }
  async refresh() {
    await y.refresh();
  }
  models() {
    return y.getByService(this.service);
  }
  static get(t, e, o = {}) {
  ...
  static factories(t) {
    ...
    return Object.keys(e).map((o) => {
      ...
      return o.includes("/") && (Z = o.split("/").slice(1).join("/")), {
        ...
        output_cost_per_token: l,
        output_cost_per_reasoning_token: i,
        supports_reasoning: K,
        supports_function_calling: Y,
        supports_vision: W,
        supports_web_search: G,
        supports_audio_input: H,
        supports_audio_output: V,
        supports_prompt_caching: X,
        supported_modalities: m,
        tags: h
      };
    });
  }
  ...
  static addCustom(t) {
    b[`${t.service}/${t.model}`] = Object.assign({}, { mode: "chat" }, t);
  }
...
y.DEFAULT_BASE_URL = "https://raw.githubusercontent.com/BerriAI/litellm/refs/heads/main/model_prices_and_context_window.json";
let U = y;
const it = {
  service: "ollama",
  max_tokens: 1024
...
function T(s) {
  return function(t) {
    try {
      return t.split("```" + s)[1].split("```")[0].trim();
    } catch (e) {
      throw J.error(`error parsing code block of type ${s} from content`, t), e;
    }
  };
}
function yt(s) {
...
function at(s) {
  try {
    ...
    try {
      ...
      throw J.error("error parsing json from content", s), o;
    }
  }
}
function wt(s) {
  return function(t) {
    try {
      const e = t.split(`<${s}>`)[1].split(`</${s}>`)[0].trim();
      if (!e || e.length == 0)
        throw new Error(`No content found inside of XML tag ${s}`);
      return e;
    } catch (e) {
      throw J.error(`error parsing xml tag ${s} from content`, t), e;
    }
  };
}
const ct = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  markdown: yt,
  xml: wt
}, Symbol.toStringTag, { value: "Module" })), zt = {}, $t = P("llm.js:utils");
async function ut(s, t = "Error while handling response") {
  if (s.ok) return !0;
  let e;
  try {
    e = await s.json();
  } catch {
    let r = "Unable to parse response";
    throw s.status && s.statusText && (r = `${s.status} ${s.statusText}`), new Error(r);
  }
  let o = t;
...
async function* qt(s) {
  const t = s.getReader(), e = new TextDecoder();
  let o = "";
  for (; ; ) {
    let { done: _, value: r } = await t.read();
    if (_) break;
    let p = e.decode(r, { stream: !0 });
    if (!p) continue;
    const u = p.split(`
`);
    let n = [];
...
`);
    for (const i of l)
      try {
        ...
        if (yield m, m.type === "message_stop" || m.type === "response.completed" || m.done) {
          _ = !0;
          break;
        }
      } catch {
...
`);
  ...
  if (o.length > 0)
    try {
      ...
      $t.error("Error parsing JSON LINE:", o);
    }
}
function Mt(s, t) {
  return s.filter((e) => e.role === t);
}
function Lt(s, t) {
  return s.filter((e) => e.role !== t);
}
...
function lt(s) {
  if (!s.name) throw new Error("Tool name is required");
  if (!s.description) throw new Error("Tool description is required");
  if (!s.input_schema) throw new Error("Tool input schema is required");
  return {
    type: "function",
...
function Q(s) {
  if (!s.function) throw new Error("Tool call function is required");
  if (s.function.id || (s.function.id = crypto.randomUUID()), !s.function.name) throw new Error("Tool call function name is required");
  if (!s.function.arguments) throw new Error("Tool call function arguments is required");
  let t = s.function.arguments;
  return typeof t == "string" && (t = JSON.parse(t)), { id: s.function.id, name: s.function.name, input: t };
}
function N(s, t) {
  for (const e of t)
...
function R() {
  return typeof window < "u" && !mt();
}
function mt() {
  return typeof process < "u" && !R();
}
R() || process.env;
function M(s) {
  ...
  if (s.constructor !== Object) {
    const e = Object.create(Object.getPrototypeOf(s));
    for (const o in s)
      s.hasOwnProperty(o) && (e[o] = M(s[o]));
    return e;
  }
  const t = {};
  for (const e in s)
    s.hasOwnProperty(e) && (t[e] = M(s[e]));
  return t;
}
function c(...s) {
  ...
  if (t.startsWith("http://") || t.startsWith("https://")) {
    const [r, ...p] = t.split("://"), u = s.slice(1), l = [p.join("://"), ...u].join("/").replace(/\/+/g, "/");
    return `${r}://${l}`;
  }
  let o = [];
  for (let r = 0, p = s.length; r < p; r++)
    o = o.concat(s[r].split("/"));
  const _ = [];
...
const F = P("llm.js:index"), w = class w {
  constructor(t, e = {}) {
    this.abortController = null, this.cache = {};
    const o = this.constructor;
    this.service = e.service ?? this.constructor.service, this.messages = [], t && typeof t == "string" ? this.user(t, e.attachments) : t && Array.isArray(t) && (this.messages = t), this.options = e, this.model = e.model ?? o.DEFAULT_MODEL, this.baseUrl = e.baseUrl ?? o.DEFAULT_BASE_URL, this.modelUsage = new U(this.service), this.stream = e.stream ?? !1, this.max_tokens = e.max_tokens ?? it.max_tokens, this.extended = e.extended ?? !1, this.think = e.think ?? !1, this.qualityFilter = e.qualityFilter ?? {}, typeof e.temperature == "number" && (this.temperature = e.temperature), typeof e.max_thinking_tokens == "number" && (this.max_thinking_tokens = e.max_thinking_tokens), typeof e.parser == "string" && (this.parser = this.parsers[e.parser]), typeof e.json == "boolean" && (this.json = e.json), this.json && !this.parser && (this.parser = at), Array.isArray(e.tools) && (this.tools = e.tools), this.think && (this.extended = !0), this.tools && this.tools.length > 0 && (this.extended = !0), F.debug(`LLM ${this.service} constructor`);
  }
  get isLocal() {
  ...
  get apiKey() {
    ...
    } else if (mt() && typeof process < "u" && (t = process.env) != null && t[`${this.service.toUpperCase()}_API_KEY`])
  ...
  get chatUrl() {
    return c(this.baseUrl, "api/chat");
  }
  get modelsUrl() {
    return c(this.baseUrl, "api/tags");
  }
  getChatUrl(t) {
    return this.chatUrl;
  }
  ...
  user(t, e) {
    if (e && e.length > 0) {
      const o = this.constructor.MessageExtendedContentInputKey;
      this.addMessage("user", { type: o, text: t, attachments: e });
    } else
  ...
  async chat(t, e) {
    const o = (e == null ? void 0 : e.attachments) || [];
    return this.user(t, o), await this.send(e);
  }
  abort() {
    this.abortController && this.abortController.abort();
  }
  async send(t) {
    t == null || delete t.attachments;
    const e = { ...this.llmOptions, ...t || {} }, o = this.parseOptions(JSON.parse(JSON.stringify(e)));
    this.resetCache(), o.tools && o.tools.length > 0 && (this.extended = !0), F.debug(`LLM ${this.service} send`), this.abortController = new AbortController();
    ...
    if (await ut(_, "Failed to send request"), this.stream) {
      const r = _.body;
      if (!r) throw new Error("No body found");
      return this.extended ? this.extendedStreamResponse(r, e) : this.streamResponse(r);
    }
    try {
      const r = await _.json();
      return this.extended ? this.extendedResponse(r, e) : this.response(r);
    } finally {
  ...
  extendedResponse(t, e) {
    ...
    if (_ && (o.usage = this.parseUsage(_)), e.think) {
      const p = this.parseThinking(t);
      p && (o.thinking = p, this.thinking(p));
    }
    let r = this.parseContent(t);
    if (this.parser && (r = this.parser(r)), r && this.assistant(r), this.tools && this.tools.length > 0) {
      o.tool_calls = this.parseTools(t);
      for (const p of o.tool_calls)
        p && Object.keys(p).length > 0 && this.toolCall(p);
    }
    return o.content = r, o.messages = JSON.parse(JSON.stringify(this.messages)), o;
  }
  ...
  async *streamResponses(t, e) {
    ...
    for await (const r of o)
      for (const [p, u] of Object.entries(e)) {
        const n = u(r);
        if (n)
          if (p === "usage")
            _[p] = n, yield { type: p, content: n };
          else if (p === "tool_calls") {
            if (!Array.isArray(n) || n.length === 0) continue;
            _[p] || (_[p] = []), _[p].push(...n), yield { type: p, content: n };
          } else
            _[p] || (_[p] = ""), _[p] += n, yield { type: p, content: n };
      }
  ...
  extendedStreamResponse(t, e) {
    let o, _ = "", r = "", p = [];
    const u = async () => {
      const i = JSON.parse(JSON.stringify(this.messages)), m = { service: this.service, options: e, usage: o, messages: i, content: r };
      return _ && (m.thinking = _), p.length > 0 && (m.tool_calls = p), this.abortController = null, m;
    }, n = this.streamResponses(t, this.parsers), l = this.restream(n, (i) => {
      if (i.type === "usage" && i.content && typeof i.content == "object") {
        const m = i.content;
        o = this.parseUsage(m);
      }
      i.type === "tool_calls" && i.content && Array.isArray(i.content) && p.push(...i.content), i.type === "buffers" && (i.thinking && (_ = i.thinking), i.content && (r = i.content));
    });
    return { service: this.service, options: e, stream: l, complete: u, think: this.think ?? !1 };
  }
  async fetchModels() {
    const t = { headers: this.llmHeaders };
    F.debug(`LLM ${this.service} fetchModels`);
    const e = await fetch(this.getModelsUrl(), t);
    await ut(e, "Failed to fetch models");
  ...
  getDefaultModelUsage(t) {
    return {
      ...
      max_input_tokens: t.max_input_tokens || 0,
      max_output_tokens: t.max_output_tokens || 0,
      supports_reasoning: t.supports_reasoning || !1,
      supports_function_calling: t.supports_function_calling || !1,
      supports_vision: t.supports_vision || !1,
      supports_web_search: t.supports_web_search || !1,
      supports_audio_input: t.supports_audio_input || !1,
      supports_audio_output: t.supports_audio_output || !1,
      supports_prompt_caching: t.supports_prompt_caching || !1,
      tags: t.tags || []
    };
  }
  async getModels(t = {}) {
    return (await this.fetchModels()).map((o) => {
      let _ = U.get(this.service, o.model, t) || {};
      if (Object.keys(_).length === 0) {
        if (this.isLocal)
          if (typeof o.supports_reasoning > "u")
            if (t.allowUnknown)
            ...
            _ = this.getDefaultModelUsage(o);
        else if (_ = this.getDefaultModelUsage(o), !t.allowUnknown) throw new Error(`model info not found for ${o.model}`);
      }
      return { ..._, name: o.name, model: o.model, created: o.created, service: this.service, raw: o };
  ...
  parseMessages(t) {
    return t.map((e) => {
      const o = M(e);
      return (o.role === "thinking" || o.role === "tool_call") && (o.role = "assistant"), e.content && e.content.attachments ? o.content = this.parseAttachmentsContent(e.content) : e.content && e.content.text ? o.content = e.content.text : typeof o.content != "string" && (o.content = JSON.stringify(o.content)), o;
    });
  }
  parseAttachmentsContent(t) {
    const e = this.constructor.MessageExtendedContentInputKey, o = t.attachments.map(this.parseAttachment);
    return o.push({ type: e, text: t.text }), o;
  }
  parseAttachment(t) {
    return t.content;
  }
  ...
  parseUsage(t) {
    ...
    const r = t.input_tokens * o, p = t.output_tokens * _, u = r + p;
    return {
      ...t,
      local: this.isLocal,
...
w.parsers = ct, w.isLocal = !1, w.isBearerAuth = !1, w.MessageExtendedContentInputKey = "text";
let k = w;
const x = class x extends k {
  get chatUrl() {
    return c(this.baseUrl, "messages");
  }
  get modelsUrl() {
    return c(this.baseUrl, "models");
  }
  get llmHeaders() {
    const t = Object.assign({
      "anthropic-version": x.API_VERSION
    }, super.llmHeaders);
    return R() && (t["anthropic-dangerous-direct-browser-access"] = "true"), t;
  }
  parseOptions(t) {
    if (t.think) {
  ...
  parseTokenUsage(t) {
    var _, r, p, u, n, l;
    if (!t) return null;
    const e = ((r = (_ = t.message) == null ? void 0 : _.usage) == null ? void 0 : r.input_tokens) || ((p = t.usage) == null ? void 0 : p.input_tokens), o = ((n = (u = t.message) == null ? void 0 : u.usage) == null ? void 0 : n.output_tokens) || ((l = t.usage) == null ? void 0 : l.output_tokens);
...
x.service = "anthropic", x.DEFAULT_BASE_URL = "https://api.anthropic.com/v1", x.DEFAULT_MODEL = "claude-opus-4-20250514", x.API_VERSION = "2023-06-01";
let E = x;
const z = class z extends k {
  ...
  get modelUrl() {
    return c(this.baseUrl, "api/show");
  }
  get llmHeaders() {
  ...
  parseTools(t) {
    return !t || !t.message || !t.message.tool_calls ? [] : t.message.tool_calls.map((e) => Q(e));
  }
  parseModel(t) {
    return { name: t.model, model: t.model, created: new Date(t.modified_at) };
  }
  async fetchModel(t) {
    return await (await fetch(`${this.modelUrl}`, {
      method: "POST",
      body: JSON.stringify({ name: t })
    })).json();
  }
  async fetchModels() {
    const t = await super.fetchModels();
    for (const e of t) {
      const o = await this.fetchModel(e.model), _ = o.model_info, r = _["general.architecture"], p = _[`${r}.context_length`], u = o.capabilities ?? [];
      e.supports_reasoning = u.includes("thinking"), e.supports_function_calling = u.includes("tools"), e.supports_vision = u.includes("vision"), e.supports_web_search = !1, e.supports_audio_input = !1, e.supports_audio_output = !1, e.supports_prompt_caching = !1, e.max_tokens = p, e.tags = [], e.supports_reasoning && e.tags.push("reasoning"), e.supports_function_calling && e.tags.push("tools"), e.supports_vision && e.tags.push("images");
    }
    return t;
  }
  async verifyConnection() {
  ...
  parseMessages(t) {
    ...
    for (const o of t) {
      let _ = !1;
      (o.role === "thinking" || o.role === "tool_call") && (o.role = "assistant"), o.role && o.content.text && (e.push({ role: o.role, content: o.content.text }), _ = !0), o.role && o.content.attachments && (e.push({ role: o.role, images: o.content.attachments.map(this.parseAttachment) }), _ = !0), _ || e.push(o);
    }
    return e;
  }
  parseAttachmentsContent(t) {
    return [{
      role: "user",
      content: t.text,
      images: t.attachments.map(this.parseAttachment)
    }];
  }
  parseAttachment(t) {
    if (t.isImage && !t.isURL)
      return t.data;
    throw new Error("Unsupported attachment type");
  }
};
z.service = "ollama", z.DEFAULT_BASE_URL = "http://localhost:11434", z.DEFAULT_MODEL = "gemma3:4b", z.isLocal = !0;
let I = z;
const g = class g extends k {
  get chatUrl() {
    return c(this.baseUrl, "responses");
  }
  get modelsUrl() {
    return c(this.baseUrl, "models");
  }
  ...
  parseAttachment(t) {
    const e = t.isURL ? t.data : `data:${t.contentType};base64,${t.data}`;
    if (t.isImage)
      return { type: "input_image", image_url: e };
    if (t.isDocument)
      return { type: "input_file", filename: crypto.randomUUID(), file_data: e };
    throw new Error("Unsupported attachment type");
  }
  filterQualityModel(t) {
    const e = [
...
g.service = "openai", g.DEFAULT_BASE_URL = "https://api.openai.com/v1", g.DEFAULT_MODEL = "gpt-4o-mini", g.isBearerAuth = !0, g.MessageExtendedContentInputKey = "input_text";
let A = g;
function Ut(s) {
  return {
    name: s.name,
    parameters: Object.assign({}, s.input_schema, { additionalProperties: !1 }),
    strict: !0,
    type: "function",
...
const $ = class $ extends k {
  get chatUrl() {
    return c(this.baseUrl, "chat/completions");
  }
  get modelsUrl() {
    return c(this.baseUrl, "models");
  }
  getChatUrl(t) {
    return c(this.baseUrl, "models", `${t.model}:generateContent?key=${this.apiKey}`);
  }
  getModelsUrl() {
    return `${this.modelsUrl}?key=${this.apiKey}`;
  }
  parseOptions(t) {
    const e = M(t), o = e.messages || [], _ = Mt(o, "system"), r = Lt(o, "system");
    return delete e.messages, _.length > 0 && (e.system_instruction = { parts: _.map((p) => ({ text: p.content })) }), r.length > 0 && (e.contents = r.map($.toGoogleMessage)), e.generationConfig || (e.generationConfig = {}), typeof e.temperature == "number" && (e.generationConfig.temperature = e.temperature), typeof e.max_tokens == "number" && (e.generationConfig.maxOutputTokens = e.max_tokens), e.generationConfig.maxOutputTokens || (e.generationConfig.maxOutputTokens = this.max_tokens), e.tools && (e.tools = [{ functionDeclarations: e.tools.map((p) => ({
      name: p.name,
      description: p.description,
      parameters: p.input_schema
    })) }]), e.think && (e.generationConfig || (e.generationConfig = {}), e.generationConfig.thinkingConfig = { includeThoughts: !0 }, delete e.think), delete e.think, delete e.max_tokens, delete e.temperature, delete e.stream, e;
  }
  parseMessages(t) {
    return t.map((e) => {
      const o = M(e);
      return (o.role === "thinking" || o.role === "tool_call") && (o.role = "assistant"), typeof o.content != "string" && !(o.content && o.content.attachments) && (o.content = JSON.stringify(o.content)), o;
    });
  }
  get llmHeaders() {
    const t = super.llmHeaders;
  ...
  parseContent(t) {
    var o, _, r;
    if (!((r = (_ = (o = t == null ? void 0 : t.candidates) == null ? void 0 : o[0]) == null ? void 0 : _.content) != null && r.parts)) return "";
  ...
  parseModel(t) {
    return {
      ...
      // :(
      max_input_tokens: t.inputTokenLimit,
      max_output_tokens: t.outputTokenLimit
    };
  }
  parseTools(t) {
    var o, _, r, p, u;
    if (!((u = (p = (r = (_ = (o = t == null ? void 0 : t.candidates) == null ? void 0 : o[0]) == null ? void 0 : _.content) == null ? void 0 : r.parts) == null ? void 0 : p[0]) != null && u.functionCall)) return [];
    const e = t.candidates[0].content.parts[0].functionCall;
    return [{ id: Bt(), name: e.name, input: e.args }];
  }
  parseThinking(t) {
    var o, _, r;
    if (!((r = (_ = (o = t == null ? void 0 : t.candidates) == null ? void 0 : o[0]) == null ? void 0 : _.content) != null && r.parts)) return "";
  ...
  parseAttachment(t) {
    if (t.isImage && !t.isURL)
      return { inline_data: { mime_type: t.contentType, data: t.data } };
    throw new Error("Unsupported attachment type");
  }
  parseAttachmentsContent(t) {
    var o;
    const e = ((o = t.attachments) == null ? void 0 : o.map(this.parseAttachment.bind(this))) || [];
    return t.text && e.push({ text: t.text }), e;
  }
  filterQualityModel(t) {
    const e = ["embedding", "vision", "learnlm", "image-generation", "gemma-3", "gemma-3n", "gemini-1.5", "embedding"];
    return N(t.model, e);
  }
  static toGoogleMessage(t) {
    if (t.content && typeof t.content == "object" && t.content.attachments) {
      const e = [];
      for (const o of t.content.attachments)
        if (o.contentType !== "url")
          e.push({
            inline_data: {
      ...
      return t.content.text && e.push({ text: t.content.text }), {
        role: t.role === "assistant" ? "model" : t.role,
        parts: e
      };
    } else {
      const e = typeof t.content == "string" ? t.content : JSON.stringify(t.content);
      return {
        role: t.role === "assistant" ? "model" : t.role,
        parts: [{ text: e }]
      };
  ...
  static fromGoogleMessage(t) {
    const e = t.parts;
    if (e.length === 1 && "text" in e[0] && e[0].text)
      return { role: t.role, content: e[0].text };
    if (e.length === 2 && "inline_data" in e[0] && "text" in e[1] && e[0].inline_data && e[1].text)
      return {
        role: t.role,
        content: {
          text: e[1].text,
          attachments: [{
            type: "image",
            contentType: e[0].inline_data.mime_type,
            data: e[0].inline_data.data
          }]
        }
      };
...
$.service = "google", $.DEFAULT_BASE_URL = "https://generativelanguage.googleapis.com/v1beta/", $.DEFAULT_MODEL = "gemini-2.5-flash-preview-05-20";
let S = $;
const v = class v extends k {
  ...
  parseTools(t) {
    return !t || !t.choices || !t.choices[0] || !t.choices[0].message || !t.choices[0].message.tool_calls ? [] : t.choices[0].message.tool_calls.map((e) => Q(e));
  }
  parseToolsChunk(t) {
    return !t || !t.choices || !t.choices[0] || !t.choices[0].delta || !t.choices[0].delta.tool_calls ? [] : t.choices[0].delta.tool_calls.map((e) => Q(e));
  }
  filterQualityModel(t) {
  ...
  parseAttachment(t) {
    if (t.isImage)
      return t.isURL ? { type: "image_url", image_url: { url: t.data, detail: "high" } } : { type: "image_url", image_url: { url: `data:${t.contentType};base64,${t.data}`, detail: "high" } };
    throw new Error("Unsupported attachment type");
  }
};
v.service = "openai", v.DEFAULT_BASE_URL = "", v.DEFAULT_MODEL = "", v.isBearerAuth = !0, v.KEY_REASONING_CONTENT = "reasoning_content";
let f = v;
const L = class L extends f {
};
L.service = "xai", L.DEFAULT_BASE_URL = "https://api.x.ai/v1/", L.DEFAULT_MODEL = "grok-3";
let D = L;
const q = class q extends f {
  parseOptions(t) {
  ...
  filterQualityModel(t) {
    return N(t.model, ["whisper", "tts"]);
  }
};
q.service = "groq", q.DEFAULT_BASE_URL = "https://api.groq.com/openai/v1/", q.DEFAULT_MODEL = "deepseek-r1-distill-llama-70b", q.KEY_REASONING_CONTENT = "reasoning";
let O = q;
const B = class B extends f {
};
B.service = "deepseek", B.DEFAULT_BASE_URL = "https://api.deepseek.com/v1/", B.DEFAULT_MODEL = "deepseek-chat";
let j = B;
class d {
  constructor(t, e, o) {
    this.data = t, this.type = e, this.contentType = o;
  }
  get isImage() {
  ...
  get source() {
    return this.contentType === "url" ? { type: "url", url: this.data } : { type: "base64", media_type: this.contentType, data: this.data };
  }
  static fromBase64(t, e, o) {
    return new d(t, e, o);
  }
  static fromJPEG(t) {
    return new d(t, "image", "image/jpeg");
  }
  static fromPNG(t) {
    return new d(t, "image", "image/png");
  }
  static fromGIF(t) {
    return new d(t, "image", "image/gif");
  }
  static fromWEBP(t) {
    return new d(t, "image", "image/webp");
  }
  static fromSVG(t) {
    return new d(t, "image", "image/svg+xml");
  }
  static fromTIFF(t) {
    return new d(t, "image", "image/tiff");
  }
  static fromPDF(t) {
    return new d(t, "document", "application/pdf");
  }
  static fromImageURL(t) {
    return new d(t, "image", "url");
  }
  static fromDocumentURL(t) {
    return new d(t, "document", "url");
  }
}
let C = [E, I, A, S, D, O, j];
function Ct(s, t) {
  let e, o;
  typeof s == "string" || Array.isArray(s) ? (e = s, o = t || {}) : typeof s == "object" && s !== null ? (e = void 0, o = s) : (e = void 0, o = {});
  let _;
  const r = (o == null ? void 0 : o.service) ?? it.service;
  let p = C.find((n) => n.service === r);
  return p || (p = f), _ = new p(e, o), new.target ? _ : _.send();
}
const a = Ct;
a.parsers = ct;
a.services = C;
